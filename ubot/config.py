...
BOT_TOKEN = os.getenv("BOT_TOKEN", "6682570018:AAGYrlug5238c_8urXb4XLEE-rXNl6z_AM8")
...
MONGO_URL = os.getenv(
    "MONGO_URL",
    "mongodb+srv://reja1:reja1@reja.vgmdpe2.mongodb.net/?retryWrites=true&w=majority",
)
